# =============================================================================
# Longitudinal Likelihood: OU Individual Process (delta_est + neg2llh)
# =============================================================================
# Rcpp/inline implementation of two functions for the OU longitudinal model:
#   delta_est(theta_trans, data_split_cube, A_list) -> vec
#     Computes the Rosenberg delta estimator (population spline coefficients).
#     theta_trans = (log(zeta_vec), log(nu2_vec), log(xi_vec), log(d_vec), l_vec)
#     where: zeta = population smoothing variances (q-vector)
#            nu2  = OU innovation variances (q-vector)
#            xi   = OU mean-reversion rates (q-vector)
#            d    = Cholesky diagonal of cross-biomarker covariance Sigma
#            l    = Cholesky lower triangle of Sigma
#
#   neg2llh(theta_trans, data_split_cube, A_list) -> double
#     Returns -2 * longitudinal log-likelihood (no survival term).
#     Used for GA-based univariate initialization in albumin_fit.R.
#
# Inputs (R-level):
...
#   A_list_in:       list of length npt; A_list_in[[t]] = alive-at-t subject indices
# =============================================================================
...
delta_llh_OU = cxxfunction(signature(theta_trans_in = "numeric", data_split_in = "numeric", A_list_in = "numeric"), includes = rcpp_inc, body = src, plugin = "RcppArmadillo")
