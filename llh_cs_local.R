# =============================================================================
# Longitudinal Likelihood: Cubic Spline Population + Local Level Individual
# =============================================================================
# Rcpp/inline implementation of neg2llh for the cubic-local model.
# Used in model_comparison_synth.R as part of the sensitivity analysis.
# Individual trajectories use a local level (random walk) process (d_v = q state dim).
# Differs from llh_cs_cs.R only in T_v, Z_v, Sig_v matrices (see paper Section 3.1).
#
# Parameter vector theta_trans: same structure as llh_cs_cs.R.
#
# Inputs (R-level):
...
// variance parameters, subject level
from = q;
to = 2 * q - 1;
